    ...
    public class FitnessRecordUI extends JFrame {
            ...
            saveButton.addActionListener(e -> {
                try {
                    ...
                    if (index != -1) {
                        ...
                        displayLog(logs.get(index).getExercise(), logs.get(index).getDate(), "Exercise chosen");
                    } else {
                        JOptionPane.showMessageDialog(dialog, "No matching exercise found");
                    }
        ...
        private void updateOptions(Log logs) {
            JDialog dialog = createDialog("Update Exercise Options", 400, 400);
    
            Exercise curExercise = logs.getExercise();
            JPanel updateExercisePanel = new JPanel();
            ...
            yearField = new JTextField(String.valueOf(logs.getDate().split("/")[0]));
            monthField = new JTextField(String.valueOf(logs.getDate().split("/")[1]));
            dayField = new JTextField(String.valueOf(logs.getDate().split("/")[2]));
            ...
            updateButton.addActionListener(e -> {
                try {
                    ...
                    if ("Exercise Name".equals(selected)) {
                        ...
                        String updatedDate = String.format("%s/%s/%s", yearField.getText(), monthField.getText(), dayField.getText());
                        logs.updateDate(updatedDate);
                    }
